...
console.log("DYNAMICS_TENANT_ID:", TENANT_ID);
console.log("DYNAMICS_CLIENT_ID:", CLIENT_ID);
console.log("DYNAMICS_CLIENT_SECRET:", CLIENT_SECRET);
console.log("DYNAMICS_ORG_URL:", ORG_URL);
